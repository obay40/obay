  ...
  return (
    <Container className="py-16">
      <div className="mx-auto max-w-sm">
        <h1 className="text-navy-900 text-2xl font-bold">Anmelden</h1>
        <p className="text-navy-600 mt-1 text-sm">Melde dich bei deinem Autoklick24-Konto an.</p>
        ...
        <p className="text-navy-600 mt-6 text-center text-sm">
          Noch kein Konto?{" "}
          <Link href="/registrieren" className="text-brand-600 hover:text-brand-700 font-medium">
            Jetzt registrieren
          </Link>
        </p>
      </div>
